...
public class SeckillExcecution {
    ...
    public SeckillExcecution(long seckillId, SeckillStateEnum stateEnum, SuccessKilled successKilled) {
    ...
    public SeckillExcecution(long seckillId, SeckillStateEnum stateEnum) {
        this.seckillId = seckillId;
        this.state = stateEnum.getState();
        this.stateInfo = stateEnum.getStateInfo();
    }
